    ...
    <div class="card-formulario-pedido">
        <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="campo-formulario">
                            ...
                            <div class="valor-campo">
                                <span class="tipo-cliente-badge <?= $pedido->id_cliente ? 'frecuente' : 'ocasional' ?>">
                                    <?= $pedido->id_cliente ? '👥 Cliente Frecuente' : '👤 Cliente Ocasional' ?>
                                </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="seccion-formulario">
                ...
                <?php if ($pedido->id_cliente && !empty($clienteFrecuente)): ?>
                <!-- CLIENTE FRECUENTE -->
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="campo-formulario">
                            ...
                            <div class="valor-campo"><?= htmlspecialchars($clienteFrecuente->razon_social) ?></div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="campo-formulario">
                            ...
                            <div class="valor-campo"><?= htmlspecialchars($clienteFrecuente->domicilio) ?></div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="campo-formulario">
                            ...
                            <div class="valor-campo"><?= htmlspecialchars($clienteFrecuente->telefono ?? 'No especificado') ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="campo-formulario">
                            ...
                            <div class="valor-campo"><?= htmlspecialchars($clienteFrecuente->municipio ?? 'No especificado') ?></div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="campo-formulario">
                            <label><strong>Estado</strong></label>
                            <div class="valor-campo"><?= htmlspecialchars($clienteFrecuente->estado ?? 'No especificado') ?></div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="campo-formulario">
                            ...
                            <div class="valor-campo"><?= htmlspecialchars($clienteFrecuente->codigo_postal ?? 'No especificado') ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="campo-formulario">
                            ...
                            <div class="valor-campo">
                                <?php if (!empty($clienteFrecuente->correo_electronico)): ?>
                                    <a href="mailto:<?= htmlspecialchars($clienteFrecuente->correo_electronico) ?>">
                                        <?= htmlspecialchars($clienteFrecuente->correo_electronico) ?>
                                    </a>
                                <?php else: ?>
                                    No especificado
                                <?php endif; ?>
                    ...
                    <div class="col-md-6">
                        <div class="campo-formulario">
                            ...
                            <div class="valor-campo">#<?= htmlspecialchars($pedido->id_cliente) ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="alert alert-warning">
                    ...
                    <strong>Cliente Ocasional</strong>
                </div>
                    ...
                    <div class="campo-formulario">
                        ...
                        <div class="valor-campo">
                            ...
                            $servicios = [
                                ...
                                'Escombro' => 'Recolección de Escombro', 
                                'Madera' => 'Recolección de Madera',
                                'Otro' => 'Otro servicio'
                            ];
                            echo $servicios[$pedido->servicio] ?? 'No especificado';
                            ?>
                        </div>
                    </div>
                </div>
