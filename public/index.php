...
//funcion para clientes frecuentes y ocasionales
$router->get('/pedidos/api-cliente', [PedidosController::class, 'apiCliente']);

// Manifiestos eliminar
$router->post('/manifiestos/eliminar', [ManifiestosController::class, 'eliminar']);

//servicios de unidades
$router->get('/servicios_de_unidades/crear', [ServicioUnidadController::class, 'crear']);
$router->post('/servicios_de_unidades/crear', [ServicioUnidadController::class, 'crear']);
$router->get('/servicios_de_unidades/historial_de_servicios', [ServicioUnidadController::class, 'historial']);
$router->post('/servicios_de_unidades/completar', [ServicioUnidadController::class, 'completar']);

// Cambiar estado de servicio
$router->post('/servicios_de_unidades/cambiar_estado', [ServicioUnidadController::class, 'cambiar_estado']);
